...
eig_num = 3
prefix = './data/'
postfix = '-v'+str(vehicle_num)+'-'+str(eig_num)+'-100%'+'.mat'
dataset_name_list = ['Scenario-MA', 'Scenario-FT', 'Scenario-ZS', 'Scenario-EP','Scenario-SR']
...
for u in range(len(dataset_name_list)):
    ...
    print("--------------------------------------------\n")
    print("batchsize:", args_mdn['batch_size'])
    print('sample size 1:', args['sample_size_1'])
    print('ds len:', dataSet_1.__len__())
    print('info_interval:', info_interval)
    if info_interval==0:
        info_interval=1
        print("update the info interval")
    print("----------------------------------------------")
